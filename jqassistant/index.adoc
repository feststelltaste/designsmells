...
digraph g {
    ...
    CyclicSubtype [ label=<{<b><i>CyclicSubtype</i></b><br/>|<i>+getData()</i><br/>}> ]
    CyclicSupertype [ label=<{<b><i>CyclicSupertype</i></b><br/>|<i>+callSubtype()</i><br/>}> ]

    edge [
        fontsize = 8
    ]
    CyclicSupertype -> CyclicSubtype
