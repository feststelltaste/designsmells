...
AND
  (class)<-[:CONTAINS]–(:Package {name: "passive"})
RETURN
  class AS Class, field AS Field, method AS `used by`
----
// end::designsmellPassiveAbstraction[]

// tag::designsmellPassiveAbstractionAdvanced[]
[[designsmell:PassiveAbstractionAdvanced]]
...
RETURN
  *
----
// end::designsmellPassiveAbstractionAdvanced[]
